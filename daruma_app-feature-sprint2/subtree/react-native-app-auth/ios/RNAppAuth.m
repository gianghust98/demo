...
RCT_REMAP_METHOD(authorize,
                 ...
                 serviceConfiguration: (NSDictionary *_Nullable) serviceConfiguration
                 tokenEndpointAuthMethod: (NSString *) tokenEndpointAuthMethod
                 autoState: (BOOL) autoState
                 state: (NSString *) state
                 autoNonce: (BOOL) autoNonce
                 ...
                 reject: (RCTPromiseRejectBlock)  reject)
{
    ...
    NSString* changeState = autoState? [OIDAuthorizationRequest generateState] : state;
    NSString* changeNonce = autoNonce? [OIDAuthorizationRequest generateState] : nonce;
                            ...
                            reject: (RCTPromiseRejectBlock)  reject
{
    ...
    NSString *nonce = useNonce ? [[self class] generateState] : nonceT;
