...
export default class GraphSettingWeight {
        ...
        static create(child, startDate, endDate, data){
            ...
            //上限レンジの設定
            setting.setDataRangeHeight(ChildGraphComponent.getGraphData(child, startDate, endDate, 1, 0))
            //下限の設定
            setting.setDataRangeLow(ChildGraphComponent.getGraphData(child, startDate, endDate, 1, 1))
            //データの設定
            ...
            //縦目盛の設定
            setting.calcScale(0.1)
            //単位テキスト設定
            setting.mUnitText = "kg"
            ...
            setting.mEmptyText = "直近の体重記録がありません"
        ...
        static  createGraphObject( data ) {
            ...
            for (dto of data) {
                ...
                object.dataY = dto.record_weight.weight
                objects.push(object)
            }
            return objects
        }
